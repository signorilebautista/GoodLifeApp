...
/** Convierte una URL de YouTube (watch, youtu.be, shorts) a su versión /embed para mostrarla en un iframe. */
...
export default function EntrenamientoPage() {
    ...
    useEffect(() => {
        ...
        // Mostramos el plan cacheado al toque, y lo actualizamos con el que tenga el servidor
        // por si el profe cargó uno nuevo después del último login.
        ...
        fetch(`${API_URL}/socios/${dni}/plan`)
            ...
            .catch(() => {
                // si falla, nos quedamos con lo que había en caché
            })
                                ...
                                <div className="p-2 space-y-1">
                                    {ejercicios.map((exercise) => (
                                        <div key={exercise.idEjercicio} className="flex items-center justify-between p-3 hover:bg-white/10 rounded-xl transition-colors">
                                            <p className="font-semibold text-white text-base capitalize">{exercise.name}</p>
